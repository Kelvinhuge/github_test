...
#if CLID_DEBUG
static char* getStateString( const SME_STATE *state );
static char* getEventString( int event );
#endif
...
static int actionPreventIdle( void *datap );
static int actionAllowIdle( void *datap );
...
static int actionVmwi( CLASSSTM_PARM *parmp, UINT16 type );
...
static int actionPolNormalAfterFskDelay( void *datap );
static int actionPolNormal( void *datap );
...
extern const SME_STATE stateClidTxLrAsPolNomal[];
...
{CLASSSTM_CLID_TX_END,        stateClidTxLrAsPolNomal,   {actionPolNormalAfterFskDelay, 0, 0}},
{CLASSSTM_TONE_GEN_EVT,       stateClidTxLrAsPolNomal,   {actionPolNormalAfterFskDelay, 0, 0}},
{CLASSSTM_TIMER_EXPIRE,       stateClidTxLrAsIdle,       {actionClidTxCleanup, actionStopRing, 0}},
{CLASSSTM_RING_OFF,           stateClidTxLrAsIdle,       {actionClidTxCleanup, actionStopRing, 0}},
{CLASSSTM_OFFHOOK,            stateClidTxLrAsIdle,       {actionClidTxCleanup, actionStopRing, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};

const SME_STATE stateClidTxLrAsPolNomal[] = {
{CLASSSTM_TIMER_EXPIRE,       stateClidTxLrAsPostClidTx, {actionPolNormal, 0, 0}},
{CLASSSTM_RING_OFF,           stateClidTxLrAsIdle,       {actionStopRing, actionNormalPolarity, 0}},
{CLASSSTM_OFFHOOK,            stateClidTxLrAsIdle,       {actionStopRing, actionNormalPolarity, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};
...
{CLASSSTM_VMWI_OSI_END,       stateVmwiSendFsk,          {actionClidTxStart, actionPreventIdle, 0}},
{CLASSSTM_OFFHOOK,            stateVmwiIdle,             {actionClidTxCleanup, 0, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};

const SME_STATE stateVmwiSendFsk[] = {
{CLASSSTM_CLID_TX_END,        stateVmwiIdle,             {actionAllowIdle, 0, 0}},
{CLASSSTM_TONE_GEN_EVT,       stateVmwiIdle,             {actionAllowIdle, 0, 0}},
{CLASSSTM_OFFHOOK,            stateVmwiIdle,             {actionAllowIdle, actionClidTxCleanup, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};
...
{CLASSSTM_TIMER_EXPIRE,       stateVmwiTxDtAsClidTx,     {actionClidTxStart, actionPreventIdle, 0}},
{CLASSSTM_OFFHOOK,            stateVmwiTxDtAsIdle,       {actionClidTxCleanup, 0, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};

const SME_STATE stateVmwiTxDtAsClidTx[] = {
{CLASSSTM_CLID_TX_END,        stateVmwiTxDtAsPostClidTx, {actionAllowIdle, actionPostVmwiFskDelay, 0}},
{CLASSSTM_TONE_GEN_EVT,       stateVmwiTxDtAsPostClidTx, {actionAllowIdle, actionPostVmwiFskDelay, 0}},
{CLASSSTM_TIMER_EXPIRE,       stateVmwiTxDtAsIdle,       {actionAllowIdle, actionClidTxCleanup, actionNormalPolarityIdle}},
{CLASSSTM_OFFHOOK,            stateVmwiTxDtAsIdle,       {actionAllowIdle, actionClidTxCleanup, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};
...
{CLASSSTM_TIMER_EXPIRE,       stateVmwiTxRpAsClidTx,     {actionClidTxStart, actionPreventIdle, 0}},
{CLASSSTM_OFFHOOK,            stateVmwiTxRpAsIdle,       {actionClidTxCleanup, 0, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};

const SME_STATE stateVmwiTxRpAsClidTx[] = {
{CLASSSTM_CLID_TX_END,        stateVmwiTxRpAsPostClidTx, {actionAllowIdle, actionPostVmwiFskDelay, 0}},
{CLASSSTM_TONE_GEN_EVT,       stateVmwiTxRpAsPostClidTx, {actionAllowIdle, actionPostVmwiFskDelay, 0}},
{CLASSSTM_TIMER_EXPIRE,       stateVmwiTxRpAsIdle,       {actionAllowIdle, actionClidTxCleanup, actionNormalPolarityIdle}},
{CLASSSTM_OFFHOOK,            stateVmwiTxRpAsIdle,       {actionAllowIdle, actionClidTxCleanup, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};
...
{CLASSSTM_TIMER_EXPIRE,       stateVmwiTxLrAsClidTx,     {actionClidTxStart, actionPreventIdle, 0}},
{CLASSSTM_OFFHOOK,            stateVmwiTxLrAsIdle,       {actionClidTxCleanup, 0, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};

const SME_STATE stateVmwiTxLrAsClidTx[] = {
{CLASSSTM_CLID_TX_END,        stateVmwiTxLrAsPostClidTx, {actionAllowIdle, actionPostVmwiFskDelay, 0}},
{CLASSSTM_TONE_GEN_EVT,       stateVmwiTxLrAsPostClidTx, {actionAllowIdle, actionPostVmwiFskDelay, 0}},
{CLASSSTM_TIMER_EXPIRE,       stateVmwiTxLrAsIdle,       {actionAllowIdle, actionClidTxCleanup, actionNormalPolarityIdle}},
{CLASSSTM_OFFHOOK,            stateVmwiTxLrAsIdle,       {actionAllowIdle, actionClidTxCleanup, 0}},
{SME_EVENT_NULL,              0,                         {0, 0, 0}}};
...
static int actionStartRing( void *datap )
{
   ...
   if ( parmp->classType == CLASS_MSG_ONHOOK_CLID )
   {
      ...
      ** delay we need to account for in order to meet the exact timing. */
      ...
      casCtlRingProfileOn( parmp->casCtlHandle, parmp->ringInfo, TRUE );
   }
...
static int actionStopRing( void *datap )
{
   ...
   casCtlRingOff( parmp->casCtlHandle, FALSE );
...
static int actionReversePolarityAndCarRing( void *datap )
{
   ...
   *parmp->evBlockp = CLASSSTM_CASEVT_BLOCK_ALL;
   ...
   casCtlRingProfileOn( parmp->casCtlHandle, &ringState, TRUE );
...
static int actionPolNormal( void *datap)
{
   ...
   casCtlSetStateGenEvent( parmp->casCtlHandle,
                           CAS_CTL_FXO_ALERTING_OHT, /*polarity back to normal*/
                           (duration - RING_AFTER_FSK_PROCESSING_DELAY_MSEC)/2 );
...
static int actionPolNormalAfterFskDelay( void *datap)
{
   ...
   casCtlSetStateGenEvent( parmp->casCtlHandle,
                           CAS_CTL_FXO_ALERTING_OHTR, /*maintain line reversal status*/
                           (duration - RING_AFTER_FSK_PROCESSING_DELAY_MSEC)/2 );
...
static int actionPreventIdle( void *datap )
{
   ...
   istwEvent(parmp->vhdHdl, ISTW_SIGNALLING, 1);
   return( SME_EVENT_NULL );
}
...
{
   CLASSSTM_PARM *parmp = (CLASSSTM_PARM *)datap;
   istwEvent(parmp->vhdHdl, ISTW_SIGNALLING, 0);
   return( SME_EVENT_NULL );
}
...
static int actionStartSasWithDelay( void *datap )
{
   ...
   if ( HAPISUCCESS != hdspToneOn( parmp->vhdHdl,
                                   parmp->lineId,
                                   parmp->callWtgInfo->profile,
                                   (UINT32)parmp->callWtgInfo->delay,
                                   0,
                                   pToneProfile,
                                   EGRESS_TONE,
                                   FALSE,
...
static int actionEnableFastSlicModes( void *datap )
{
   ...
   casCtlEnableFastSlicStateMode(parmp->casCtlHandle, TRUE);
...
static int actionDisableFastSlicModes( void *datap )
{
   ...
   casCtlEnableFastSlicStateMode(parmp->casCtlHandle, FALSE);
...
#if CLID_DEBUG
   VRG_LOG_DBG((VRG_LOG_MOD_EPT, "*** Input event '%s' 0x%lx", getEventString(event), event));
   VRG_LOG_DBG((VRG_LOG_MOD_EPT, "*** Line %d: Old state = %s", clidState->casCtlHandle, getStateString(clidState->currentStatep)));
#endif

   if(!stmParm.vhdHdl)
      VRG_LOG_WARN((VRG_LOG_MOD_EPT,  "%s: invalid VHD for line %d", __FUNCTION__, lineId ));
...
#if CLID_DEBUG
   VRG_LOG_DBG((VRG_LOG_MOD_EPT,  "*** Line %d: New state = %s", clidState->casCtlHandle, getStateString(clidState->currentStatep)));
#endif
...
void classStmReset( CLASSSTM_MEM *clidState, CLASSSTM_TYPE classStmType )
{
   ...
   UINT16         vhdHdl         = clidState->vhdHdl;
...
#if CLID_DEBUG
   VRG_LOG_DBG((VRG_LOG_MOD_EPT, "*** classStmReset: Line %d; State = %s", clidState->casCtlHandle, getStateString(clidState->currentStatep) ));
#endif
}
...
*
****************************************************************************/
BOOL classStmIsIdle( CLASSSTM_MEM *stmMemp )
{
...
/* Debug code */
#if CLID_DEBUG
char* getStateString( const SME_STATE *state )
{
#define SSTR(x) if(state == x) return #x

      SSTR( stateClidTxNaIdle           );
      SSTR( stateClidTxNaWaitSilence    );
      SSTR( stateClidTxNaSendFsk        );
      SSTR( stateClidTxNaContFsk        );

      SSTR( stateClidTxDtAsIdle         );
      SSTR( stateClidTxDtAsSendDtAs     );
      SSTR( stateClidTxDtAsPreClidTx    );
      SSTR( stateClidTxDtAsClidTx       );
      SSTR( stateClidTxDtAsPostClidTx   );
      SSTR( stateClidTxDtAsSendRing     );

      SSTR( stateClidTxRpAsIdle         );
      SSTR( stateClidTxRpAsSendRpAs     );
      SSTR( stateClidTxRpAsPreClidTx    );
      SSTR( stateClidTxRpAsClidTx       );
      SSTR( stateClidTxRpAsPostClidTx   );
      SSTR( stateClidTxRpAsSendRing     );

      SSTR( stateClidTxLrAsIdle         );
      SSTR( stateClidTxLrAsPreDtas      );
      SSTR( stateClidTxLrAsSendDtAs     );
      SSTR( stateClidTxLrAsPreClidTx    );
      SSTR( stateClidTxLrAsClidTx       );
      SSTR( stateClidTxLrAsPolNomal);
      SSTR( stateClidTxLrAsPostClidTx   );
      SSTR( stateClidTxLrAsSendRing     );

      SSTR( stateClass2Idle             );
      SSTR( stateClass2PendingCallid    );
      SSTR( stateClass2PendingSasDone   );
      SSTR( stateClass2PendingAck       );
      SSTR( stateClass2SendFsk          );
      SSTR( stateClass2PendingDelayDone );

      SSTR( stateClidTxJpIdle           );
      SSTR( stateClidTxJpSendPr         );
      SSTR( stateClidTxJpSendCar        );
      SSTR( stateClidTxJpSendFsk        );
      SSTR( stateClidTxJpSendIr         );
      SSTR( stateClidTxJpWaitOnHook     );

      SSTR( stateVmwiIdle               );
      SSTR( stateVmwiSendOsi            );
      SSTR( stateVmwiSendFsk            );

      SSTR( stateVmwiTxDtAsIdle         );
      SSTR( stateVmwiTxDtAsSendDtAs     );
      SSTR( stateVmwiTxDtAsPreClidTx    );
      SSTR( stateVmwiTxDtAsClidTx       );
      SSTR( stateVmwiTxDtAsPostClidTx   );

      SSTR( stateVmwiTxRpAsIdle         );
      SSTR( stateVmwiTxRpAsSendRpAs     );
      SSTR( stateVmwiTxRpAsPreClidTx    );
      SSTR( stateVmwiTxRpAsClidTx       );
      SSTR( stateVmwiTxRpAsPostClidTx   );

      SSTR( stateVmwiTxLrAsIdle         );
      SSTR( stateVmwiTxLrAsPreDtas      );
      SSTR( stateVmwiTxLrAsSendDtAs     );
      SSTR( stateVmwiTxLrAsPreClidTx    );
      SSTR( stateVmwiTxLrAsClidTx       );
      SSTR( stateVmwiTxLrAsPostClidTx   );
...
{
#define ESTR(x) case x: return #x
   switch(event)
   {
      ESTR( CLASSSTM_CLID_RING           );
      ESTR( CLASSSTM_CLID_NODATA_RING    );
      ESTR( CLASSSTM_RING_OFF            );
      ESTR( CLASSSTM_CLID_FIRST_RINGOFF  );
      ESTR( CLASSSTM_OFFHOOK             );
      ESTR( CLASSSTM_ONHOOK              );
      ESTR( CLASSSTM_FLASH               );
      ESTR( CLASSSTM_TIMER_EXPIRE        );
      ESTR( CLASSSTM_CLID_TX_END         );
      ESTR( CLASSSTM_CLID_SAS_CAS        );
      ESTR( CLASSSTM_CLID_SAS_ONLY       );
      ESTR( CLASSSTM_CLID_INFO           );
      ESTR( CLASSSTM_CLID_SAS_CAS_OFF    );
      ESTR( CLASSSTM_TONE_GEN_EVT        );
      ESTR( CLASSSTM_CLID_ACK_RCVD       );
      ESTR( CLASSSTM_VMWI_ON             );
      ESTR( CLASSSTM_VMWI_OFF            );
      ESTR( CLASSSTM_VMWI_OSI_END        );
      default: break;
   }
#undef ESTR
